# Projeto: Estação Meteorológica - Paragominas-PA

Este projeto realiza a coleta de dados de temperatura e umidade utilizando **Arduino Uno R4**.

## 📊 Dashboard
Acompanhe os dados em tempo real através do nosso dashboard público no ThingSpeak:
[Acesse o Dashboard Aqui](https://thingspeak.mathworks.com/channels/3019244)
